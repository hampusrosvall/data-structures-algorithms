'''
Binary search performs searching in a sorted array and runs in O(log N) time and O(1) space
...
def binary_search(array, value):
    return binary_search_iteratively(array, value, 0, len(array) - 1)

def binary_search_iteratively(array, value, left, right):
